...
\begin{document}
	...
	% słowa kluczowe
	\keywords{aplikacja internetowa, ruby on rails, system rejestrowania, naprawa, bootstrap, interfejs graficzny użytkownika}
...
\newpage	
	...
	\begin{thebibliography}{11}
		\bibitem{framework} Syed Fazle Rahman, \emph{Bootstrap. Tworzenie interfejsów stron WWW. Technologia na start!}, Wydawnictwa Helion.
		\bibitem{ror} John Elder, \emph{Ruby on Rails. Tworzenie aplikacji WWW.}, Wydawnictwa Helion.
		\bibitem{ruby} Noel Rappin, \emph{Professional Ruby on Rails.}, Wydawnictwa Wrox.
		\bibitem{api}
